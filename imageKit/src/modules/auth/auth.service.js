...
const avatarUpload = async (userId, file) => {
    ...
    try {
        ...
        const uploadResponse = await imagekit.files.upload({
            ...
            // file: fileStream, --------------------------- > for disk storage
              file: file.buffer.toString("base64"),
            fileName: file.originalname,
            folder: "user-avatars"
        })
        {
            //   upload_response:= fileId: "6823abc123",
            //   upload_response:= name: "avatar.png",
            //   upload_response:= url: "https://ik.imagekit.io/abc/avatar.png",
            //   upload_response:= thumbnailUrl: "https://ik.imagekit.io/abc/tr:n-media_library_thumbnail/avatar.png",
            //   upload_response:= height: 800,
            //   upload_response:= width: 600,
            //   upload_response:= size: 125432,
            //   upload_response:= filePath: "/user-avatars/avatar.png",
            //   upload_response:= mime: "image/png"
        }
        ...
        // fs.unlinkSync(file.path);-------------- > for disk storage
...
export { register, getMe, login, refreshToken, logout, forgotPassword, resetPassword, avatarUpload }
